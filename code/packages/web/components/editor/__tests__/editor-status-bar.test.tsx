...
describe('EditorStatusBar', () => {
  ...
  it('should render doc-level AI metrics when provided', () => {
    render(
      <EditorStatusBar
        isSaving={false}
        lastSaved={null}
        content="Hello world"
        docAI={{
          metrics: { quality: 75, clarity: 70, wordiness: 60 },
          analyzedSections: 3,
          isAnalyzing: false,
        }}
      />
    ...
    expect(screen.getByText(/AI:\s+Q75\s+C70\s+W60/)).toBeInTheDocument();
  });
});
